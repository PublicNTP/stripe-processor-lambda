...
def process_payment(event, context):
    ...
    paymentRequestStatus = _submitPaymentRequest(paymentDetails, logger)
    ...
    return  {
        ...
        "body"              : json.dumps( { "status": paymentRequestStatus } )
    }
...
def _parseLogPaymentDetails(paymentRequest, logger):
    ...
    paymentDetails = json.loads(paymentRequest['body'])['payment_info']
